---
title: API-Referenz
description: Vollständige Spezifikation der öffentlichen Go-API von ORM++.
sidebar:
  order: 4
---

Diese Seite ist der vollständige Implementierungsvertrag der öffentlichen
Go-API — jede hier dokumentierte Signatur ist implementiert und läuft
verhaltensgleich auf SQLite, PostgreSQL und YugabyteDB (identische
Testsuite, CI-Matrix). Für den Einstieg mit Beispielen siehe die
[Anleitungen](/guides/models/); für Architektur-Hintergründe und das

...
var (
	...
	ErrPlacementNotFound = errors.New("orm: deklariertes Placement existiert im Backend nicht")
	ErrPlacementMismatch = errors.New("orm: Partition liegt nicht im deklarierten Placement")
	ErrRegionHasData     = errors.New("orm: Region hält noch Daten")
	ErrUniqueConflict    = errors.New("orm: Unique-Constraint verletzt")
